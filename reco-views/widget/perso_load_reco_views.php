...
class perso_load_reco_views{
	...
	public function getProductIdViews(){
		$prod_reco = json_decode($this->product_record->also_views);

		$prod_id_views = array();

		foreach ($prod_reco as $element) {
			$prod_id_views[$element->product_id] = $element->views;
		}
        ...
        $max_item = ($settings_options['max_reco_other_views'] != '') ? $settings_options['max_reco_other_views'] : 5;
